...
ServiceKey = '7559595373776e6431356f44645554'
...
def getFreeSuggestions(yyyymm, national_code, ed_cd):
  url = "http://openAPI.seoul.go.kr:8088/7559595373776e6431356f44645554/json/ChunmanFreeSuggestions/1/5"
...
def getFreeSuggestionsService(nat_cd, ed_cd, nStartYear, nEndYear):
  jsonResult = []
  result = []
  natName = ''
...
def main():
  ...
  if(natName == ''): # 요청은 성공하였지만, 데이터 제공이 안된 경우
    ...
    # 파일 저장1 : json파일
    with open('./%d.json' % (sn), 'w', encoding='utf8') as outfile:
